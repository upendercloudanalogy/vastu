      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description: "WhatsApp numerology call — Life Path Number, lucky numbers & dates, one specific query answered. Available online for clients in Faridabad and across India.",
          },
          price: "599",
          priceCurrency: "INR",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description: "In-depth numerology reading — Life Path, Destiny & Soul Number, Personal Year Forecast, career and relationship insights. Online via WhatsApp for Faridabad & all India.",
          },
          price: "1099",
          priceCurrency: "INR",
          availability: "https://schema.org/InStock",
        ...
        },
        {
          ...
          //   description: "Online Vastu Shastra consultation — home energy assessment, room direction analysis, Vastu remedies without major renovation. Serving Faridabad, Delhi NCR & pan India.",
          // },
          price: "4999",
          priceCurrency: "INR",
          availability: "https://schema.org/InStock",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Vastu consultation fees with Monika in Faridabad start at ₹4,999 for an online Vastu guidance session. Old Home Vastu is ₹12,999, New Home Vastu Shastra is ₹20,999, and Commercial Vastu (hotels, hospitals, offices) is ₹49,999. All sessions are available online via WhatsApp.",
        },
      },
      {
        "@type": "Question",
