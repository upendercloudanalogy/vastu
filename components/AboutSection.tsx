  ...
  return (
    <section
      style={{
        ...
        background: "linear-gradient(180deg, #EFF6FF 0%, #E3F0FD 50%, #EFF6FF 100%)",
        position: "relative",
        overflow: "hidden",
      }}
    >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ position: "relative" }}>
              ...
              {/* Outer spinning ring */}
              <div style={{ position: "absolute", inset: "-18px", borderRadius: "50%", border: "1px solid rgba(30,136,229,0.15)", animation: "counterSpinNoTranslate 35s linear infinite" }} />
              {/* Inner spinning dashed ring */}
              <div style={{ position: "absolute", inset: "-8px", borderRadius: "50%", border: "2px dashed rgba(66,165,250,0.4)", animation: "slowSpinNoTranslate 20s linear infinite" }} />

              {/* Shiv Ji image — clip-path circle so gold border shows, white corners hidden */}
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  overflow: "hidden",
                  boxShadow: "0 0 40px rgba(212,175,55,0.35), 0 0 20px rgba(30,136,229,0.2)",
                }}
              >
                <Image
                  src="/shiv-2-vastu.png"
                  alt="Shiv Ji — Divine Guidance through Vastu & Numerology"
                  fill
              ...
              <div style={{ position: "absolute", top: "-4px", right: "-4px", width: "36px", height: "36px", borderRadius: "50%", background: "linear-gradient(135deg, #1E88E5, #1565C0)", border: "2px solid rgba(66,165,250,0.6)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "14px", fontWeight: 700, color: "#FFFFFF", boxShadow: "0 0 14px rgba(30,136,229,0.5)", animation: "floatY 4s ease-in-out infinite" }}>
                9
              </div>
            ...
            <div style={{ textAlign: "center", marginTop: "32px" }}>
              <h3 style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "clamp(1.4rem, 4vw, 1.8rem)", fontWeight: 700, color: "#1A3A5C", marginBottom: "4px" }}>
                Monika
              </h3>
          ...
          <div>
            ...
            <p style={{ color: "#4B7BA8", lineHeight: 1.8, marginBottom: "16px", fontSize: "clamp(0.9rem, 2vw, 1rem)" }}>
              Monika is a certified Vastu Shastra consultant and numerology practitioner based in <strong style={{ color: "#1565C0" }}>Faridabad, Haryana</strong>, with specialized training in advanced numerology, destiny analysis, name correction, and Vastu-based energy alignment for homes and businesses across India.
            </p>

            <p style={{ color: "#4B7BA8", lineHeight: 1.8, marginBottom: "32px", fontSize: "clamp(0.9rem, 2vw, 1rem)" }}>
            ...
            <ul style={{ listStyle: "none" }}>
              {credentials.map((cred, i) => (
                <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: "12px", marginBottom: "14px" }}>
                  ...
                  <span style={{ color: "#1A3A5C", fontSize: "clamp(0.85rem, 2vw, 0.95rem)", lineHeight: 1.5, paddingTop: "6px" }}>
                    {cred.text}
                  </span>
                </li>
              ))}
            ...
            <div style={{ display: "flex", gap: "clamp(12px, 3vw, 20px)", marginTop: "28px", flexWrap: "wrap" }}>
              {[
                ...
                { num: "⑨", label: "Soul Urge", color: "#1565C0" },
              ].map((item) => (
                <div key={item.label} style={{ textAlign: "center", padding: "10px 16px", background: "rgba(219,234,254,0.8)", border: `1px solid ${item.color}30`, borderRadius: "12px" }}>
                  ...
                  <div style={{ color: "#5B8DB8", fontSize: "0.72rem", marginTop: "4px" }}>{item.label}</div>
                </div>
              ))}
            </div>
          </div>
